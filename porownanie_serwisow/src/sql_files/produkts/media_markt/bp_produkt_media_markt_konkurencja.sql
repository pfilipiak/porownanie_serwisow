create table bp_produkt_media_markt_konkurencja(
...
insert into bp_produkt_media_markt_konkurencja(domain, competitor_relevance, id_produkt_bigint, common, organic_keywords, organic_traffic)
